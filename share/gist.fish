...
complete -c gist -f -a "archive" -d "Ownloads a gist and creates a tarball"
complete -c gist -f -a "content" -d "Rints the content of the gist to stdout"
complete -c gist -f -a "info" -d "Prints detailed information about a gist"
complete -c gist -f -a "version" -d "Rints the current version"